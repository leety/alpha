...
import base64
import six
from ssrd_people.vcard import Vcard
...
class Group(TranslationHelperMixin, TranslatedAutoSlugifyMixin,
    ...
    def get_absolute_url(self, language=None):
        ...
        with override(language):
            return reverse('ssrd_people:group-detail', kwargs=kwargs)
...
class Person(TranslationHelperMixin, TranslatedAutoSlugifyMixin,
    ...
    groups = SortedM2MModelField(
        'ssrd_people.Group', default=None, blank=True, related_name='people',
    ...
    def get_absolute_url(self, language=None):
        ...
        with override(language):
            ...
            try:
                url = reverse('ssrd_people:person-detail', kwargs=kwargs)
    ...
    def get_vcard_url(self, language=None):
        ...
        if slug:
            ...
            kwargs = {'pk': self.pk}
        with override(language):
            return reverse('ssrd_people:download_vcard', kwargs=kwargs)
