...
from ssrd_people import models, DEFAULT_APP_NAMESPACE
from .utils import get_valid_languages


NAMESPACE_ERROR = _(
    "Seems that there is no valid application hook for ssrd-people."
...
class PeoplePlugin(CMSPluginBase):
    ...
    TEMPLATE_NAME = 'ssrd_people/plugins/%s/people_list.html'
    module = 'People'
