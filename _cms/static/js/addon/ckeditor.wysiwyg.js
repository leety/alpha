...
CKEDITOR.stylesSet.add('default', [
    /* Add: Header tags with class */
    { 'name': 'H1 Page Header', 'element': 'h1', 'attributes': { 'class': 'page-header' }},
    { 'name': 'H2 Page Header', 'element': 'h2', 'attributes': { 'class': 'page-header' }},
    { 'name': 'H3 Page Header', 'element': 'h3', 'attributes': { 'class': 'page-header' }},
    { 'name': 'H4 Page Header', 'element': 'h4', 'attributes': { 'class': 'page-header' }},
